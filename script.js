    ...
    fetch("https://8gi380k5nd.execute-api.ap-northeast-1.amazonaws.com/Dev", requestOptions)
        ...
        .then((result) => {
            ...
            result.body.papers.forEach((paper) => {
                ...
                // Create the title div within the card header
                var titleDiv = document.createElement("div");
                titleDiv.className = "title-div";

                // Create the date badge within the title div
                var dateBadge = document.createElement("span");
                dateBadge.className = "badge badge-primary";
                dateBadge.textContent = paper.Date;

                // Create the title of the paper within the title div
                ...
                // Create the AI Summary button
                var summaryButton = document.createElement("button");
                summaryButton.className = "btn btn-outline-primary ai-summary-button";
                ...
                // Append the date badge and title to the title div
                titleDiv.appendChild(dateBadge);
                titleDiv.appendChild(paperTitle);

                // Append the title div and AI Summary button to the card header
